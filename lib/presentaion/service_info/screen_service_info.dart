...
class _TaskPageState extends State<TaskPage> {
  ...
  void initState() {
    ...
    ServiceInfoService.getServiceInfoData().then((value) {
      ...
      if (serviceInfo != null) {
        print(serviceInfo!.data![0].images![0].imageName);
      }
    });
  }

  // getServiceInfo() async {
  //   service = await ServiceInfoService().getServiceData();
  //   setState(() {});
  //   print("service");
  //   print(service);
  // }
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Text(
                                serviceInfo != null
                                    ? serviceInfo!.data![0].taskTitle.toString()
                                    : 'hai',
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        serviceInfo != null
                                            ? serviceInfo!.data![0].estDuration
                                                .toString()
                                            : "hii joji",
                                        style: const TextStyle(
                                            color: Colors.black),
