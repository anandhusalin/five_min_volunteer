...
class DrowerPage extends StatefulWidget {
   DrowerPage({Key? key}) : super(key: key);
    ...
    return SingleChildScrollView(
      child: Container(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.only(topRight:Radius.circular(50),bottomRight: Radius.circular(10)  )
        ),
                ...
                child: Column(
                  children: [
                   Align(
                     ...
                     child: Text('Name One',style: TextStyle(
                    ...
                    Row(
                      ...
                      children: [
                        Text('Subtitle one'),
                        Checkbox(value: this.isChecked2, onChanged: (bool? value){
                          setState(() {
                            isChecked2=value!;
                          });
                    ...
                    Row(
                      ...
                      children: [
                        Text('Subtitle one'),
                        Checkbox(value: this.isChecked3, onChanged: (bool? value){
                          setState(() {
                            isChecked3=value!;
                          });
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        }, icon: Icon(Icons.home,size: 30,color: primaryColor,)),

                        IconButton(onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=> TaskPage()));
                        }, icon: Icon(Icons.category,size: 30,color: primaryColor,))
                      ],
                    )
                  ],
                ),
